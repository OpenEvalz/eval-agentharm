#!/usr/bin/env python3
"""Run ONE problem of agentharm through TrustedRouter and emit a reproducibility bundle.
...
def main() -> int:
    ap = argparse.ArgumentParser(description="Run one agentharm problem via TrustedRouter")
